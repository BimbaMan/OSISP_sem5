...
int x = 0, y = 0, dx = 10, dy = 10, size_x = 100, size_y = 100, col = 0, mdx = 100, sgndx = 1, sgndy = 1, kol = 0, x2, y2, timer = 10, offset = 100, R = 100, offset1;
...
{
	PostMessage((HWND)lpArg, WM_MOVES, NULL, NULL); //либо sendmessage
}
...
void paintWind(HWND hwnd)
{
	...
	if (onPict == false)
	{
		...
		Rectangle(backDc, x, y, x + size_x, y + size_y);
